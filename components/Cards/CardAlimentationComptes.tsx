...
import { AlimentationComptes } from '@/types/alimenationComptes';

interface CardDataStatsProps {
  data : AlimentationComptes,
  children: ReactNode;
}
    ...
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          ...
          <span className="text-sm font-medium">From {data?.compteEmiteur.name} To {data?.compteReciver.name} </span>
        </div>
      </div>
