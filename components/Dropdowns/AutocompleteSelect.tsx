...
const AutocompleteSelect: FC<AutocompleteSelectProps> = ({ data, onSelect, label, placeholder }) => {
  ...
  return (
    <div className="relative z-20 w-1/2" ref={inputRef}>
      ...
      />
      {isOpen && (
        <div className="absolute top-full left-0 w-full max-h-40 overflow-y-auto border-t border-stroke bg-white dark:bg-form-input">
