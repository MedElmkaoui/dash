...
import { HiOutlineSquares2X2, HiOutlineInboxArrowDown , HiOutlineUsers, HiOutlineDocumentDuplicate, HiOutlineBuildingOffice2, HiOutlineBanknotes, HiOutlineCube, HiOutlineBuildingLibrary, HiOutlineCog6Tooth, HiOutlineDocumentChartBar  } from "react-icons/hi2";
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/agences"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("agences") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/charges"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("charges") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
