...
const NouveauxProduits = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Nouveaux Produits" showTitle={false} />
      <div className="overflow-hidden rounded-sm bg-white shadow-default dark:bg-boxdark">
        ...
        {/* Form Produit */}
        {step === 'produit' && <FormProduit type="Création" setStep={setStep} step="confirm" Categories={Categories} Comptes={Comptes} />}
          ...
          <div className="rounded-sm px-25 bg-white shadow-default dark:bg-boxdark">
            <div className="text-center py-4 px-6.5 ">
              <div className="my-25">
                ...
                <p>Les informations du produit ont été ajoutées avec succès.</p>
              </div>
