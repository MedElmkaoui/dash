...
import FormComptes from '@/components/Forms/FormComptes';
import { HiMiniArrowSmallLeft } from 'react-icons/hi2';

const NewComptes: React.FC = () => {
  const [step, setStep] = useState<string>('comptes');
  const router = useRouter();

  return (
    <>
      <Breadcrumb pageName="Nouveaux Comptes" showTitle={false} />
      <div className="overflow-hidden rounded-sm bg-white shadow-default dark:bg-boxdark">
        ...
        {/* Form Comptes */}
        {step === 'comptes' && <FormComptes type="Création" setStep={setStep} />}
        {/* Form Confirm */}
        {step === 'confirm' && (
          <div className="rounded-sm px-25 bg-white shadow-default dark:bg-boxdark">
            <div className="text-center py-4 px-6.5 ">
              <div className="my-25">
                ...
                <p>Les informations du compte ont été ajoutées avec succès.</p>
              </div>
