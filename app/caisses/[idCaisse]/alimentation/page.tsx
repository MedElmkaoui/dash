...
import {RiExchangeBoxLine, RiCheckboxCircleLine} from "react-icons/ri";
...
const AlimentationCaisse = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Alimentation Caisse" />
      <div className="overflow-hidden rounded-sm  bg-white shadow-default dark:bg-boxdark"> 
        ...
        {
          step === 'caisse' && (
          <FormAlimentationCaisse type='Alimentation' dropdownData={Cities} setStep={setStep} handleClickbtnNewUser={handleClickbtnNewUser}/>
        )}
